...
import { summarizeServer, formatClock, formatClockShort } from '../lib/dashboard.js';
              ...
              {[...logs].reverse().map((log, i) => (
                <div key={i} className="group flex gap-8 py-1 hover:bg-[var(--surface)] transition-colors rounded px-2">
                  <div className="shrink-0 flex items-center gap-4 w-32">
                    <span className="text-[var(--text-faint)] font-medium text-[12px] mono">{formatClockShort(log.ts)}</span>
