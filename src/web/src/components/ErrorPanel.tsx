...
export default function ErrorPanel() {
  ...
  return (
    <div className="rounded-xl p-5 flex-1 flex flex-col min-h-[200px]" style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
          ...
          errors.map(e => {
            ...
            return (
              <div
                ...
                style={{ background: 'rgba(239, 68, 68, 0.04)', borderLeft: '2px solid var(--red)' }}
              >
